...
1. Clone the repository:
    ...
    ```sh
    git clone https://github.com/nagaraj602/to-do-new.git
    cd to-do-new
    ```
...
Once the application is running, you can access it at `http://localhost:3004`. You can use the web interface to manage your tasks.
